...
class Player {
    ...
    #preview_changeIcon(i, id) {
        ...
        if(i == 0) {
            if (this.#preview_button) document.getElementById(this.#preview_button).className  = "fas fa-play";
            this.#preview_button = id;
        }
        // If user clicks on the pause button or preview ends
        if (i == 1)  {
            document.getElementById(this.#preview_button).className  = "fas fa-play";
            this.#preview_button = null;
        }
        // Set icon to pause
        if (i == 2) document.getElementById(this.#preview_button).className  = "fas fa-pause";
    } 
}
