    ...
    let createResultCard = (title, artist, duration, source, beatmap_id, i, y, downloaded) => {
        ...
        <div class="card">
            ...
            <div class="card_playbutton">
                <p class="play-button"><span onclick='add_download_queue(${i}, ${y})'><i ${downloaded ? "style='display:none'" : ""} id="dowload_beatmap_set_${beatmap_id}" class="fas fa-download"></i></span></p>
