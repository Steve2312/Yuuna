// Global Variables
{
    ...
    let download_card = (title, artist, beatmap_id, on_download_speed, on_download_percent, on_download_progress) => {
        ...
        <div class="download_card">
            ...
            <div class="download_card_playbutton">
                <p class="download_play-button"><span onclick='beatmap_dl.cancel_download(${beatmap_id})'><i class="fas fa-times cancel_button"></i></span></p>
            </div>
        </div>
        `);
    }
    ...
    var init_download_page = () => {
        ...
        var downloads = beatmap_dl.getDownloads();
        if (panel) {
            all_cards = "";
